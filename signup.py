...
class Signup_Window(QMainWindow):
    def __init__(self):
        ...
        self.button_1 = QPushButton("Sign Up", self)
    ...
    def create_account(self):
        ...
        # email validation
        self.valid_email = manual_module.email_validation(self.email_input_value)
        ...
        # no error
            ...
            self.alert_message.setText("Welcome " + self.name_input_value + " ! Your account has been created.")
